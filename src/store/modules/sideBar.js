  ...
  mutations: {
    ...
    SET_SELECTEDMENUSTATE(state, itemMenu) {
      ...
      function getAllParent(element,currentItem){
        ...
        let parent=getNode(element,currentItem.title).parentNode
        node=null;
        parentNode=null;        
        if(parent!=null){
          pArray.push(parent)
      ...
      // function getParent(element,currentItem,parent) {
      //   if(element.title==currentItem.title){
      //       element.default=true;
      //       parent=null;
      //       return
      //   }
      ...
      //         break;
      //       }else{
      //           getParent(item,currentItem,parent)
      //       }           
      //     }
      //   }
      // }
    ...
    getAllMenus({
      ...
      return new Promise((resolve, reject) => {
        axios
          ...
          .then(result => {
            commit('SET_SIDEBARMENU', result.data)
            resolve()
          })
          .catch(error => {
            reject(error)
